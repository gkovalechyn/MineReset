...
public class Util {
    ...
    private static final Pattern timePattern = Pattern.compile("\\d{1,}[mhdwMys]");

    public static String joinString(String[] array) {
        Util.stringBuilder.setLength(0);

        for (int i = 0; i < array.length; i++) {
            Util.stringBuilder.append(array[i]);
            if (i < (array.length - 1)) {
    ...
    public static long timeStringToLong(String string) {
        ...
        long res = 0l;
        Matcher mat = Util.timePattern.matcher(string);
